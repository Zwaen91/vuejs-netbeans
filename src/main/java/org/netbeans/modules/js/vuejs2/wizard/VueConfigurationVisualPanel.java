...
public final class VueConfigurationVisualPanel extends JPanel {
    ...
    public VueConfigurationVisualPanel() {
        initComponents();
...
//    }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel3, org.openide.util.NbBundle.getMessage(VueConfigurationVisualPanel.class, "VueConfigurationVisualPanel.jLabel3.text")); // NOI18N

        parametersTextField.setText(org.openide.util.NbBundle.getMessage(VueConfigurationVisualPanel.class, "VueConfigurationVisualPanel.parametersTextField.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel5, org.openide.util.NbBundle.getMessage(VueConfigurationVisualPanel.class, "VueConfigurationVisualPanel.jLabel5.text")); // NOI18N
